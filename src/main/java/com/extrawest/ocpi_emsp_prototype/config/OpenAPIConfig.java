package com.extrawest.ocpi_emsp_prototype.config;
...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        contact.setEmail("vladyslav.tertyshnyi@extrawest.com");
        contact.setName("Vladyslav Tertyshnyi");
        contact.setUrl("https://extrawest.com");

        License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");

        Info info = new Info()
                .title("OCPI 2.2.1 CPO prototype API")
                .version("1.0")
                .contact(contact)
